            ...
            <div class="col-lg-12">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse main-menu-item justify-content-center"
                        ...
                        <ul class="navbar-nav align-items-center">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                @endauth
                                @guest
                                <a class="btn btn-sm color-e" href="{{ route('login') }}">Para iniciar a comprar, inicia  sesion</a>
                    ...
                    <div id="carrito" class="dropdown">
                        <button class="btn color-s dropdown-toggle" type="button" id="carritoDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti-shopping-cart"></i> Mi Carrito
                        </button>
                        <div id="carritoDrop" class="dropdown-menu carritos" aria-labelledby="carritoDropdown">
                            <div class="card mt-4">
...
<style>
    ...
    .carritos{
    width: 37vh; /* Ajusta el ancho de la tarjeta según tus preferencias */
}
</style>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                 ...
                 <div class="row">
                    <div class="col-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="tetlefono" name="tetlefono" >
                        </div>
                        <div class="mb-3">
                            <label for="direccion" class="form-label">Direccion:</label>
                            <textarea class="form-control" id="direccion" name="direccion" rows="4"></textarea>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="enviarPedidoBtn">Enviar Pedido</button>
            </div>
        </div>
    </div>
</div>
