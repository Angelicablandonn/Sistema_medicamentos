            ...
            <div class="row g-0">
              <div class="col-lg-6">
                <div class="card-body p-md-5 mx-md-4">
                  ...
                  <div class="text-center">
                    ...
                    <h4 class="mt-1 mb-5 pb-1">Drogueria la economia</h4>
                  </div>
                  ...
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <a href="{{ route('register.form') }}" class="btn btn-outline-danger">Registrate</a>
                    </div>
              ...
              <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                  ...
                  <p class="small mb-0">En Droguería La Economía, estamos dedicados a proporcionarte productos farmacéuticos de calidad y un servicio excepcional. Nuestra misión es ser tu aliado confiable para mantener y mejorar tu bienestar.</p>
                </div>
              </div>
            </div>
          </div>
